...
### Phase 1–2 (real data, scheduled runs)

| Item | Monthly | Notes |
|---|---|---|
| Site hosting | **$0** | Netlify / Cloudflare Pages free tier is genuinely sufficient |
| Domain | **~$1–4** | $15–50/year ⚠️ premium `.com` can be far more |
| VPS (data recorder + cron) | **$6–25** | Hetzner CX22 ≈ $5–7; DigitalOcean/Linode ≈ $12–24 |
| Block storage for L2 archive | **$5–25** | See sizing below |
| Off-site backup | **$1–6** | Object storage, ~$0.005–0.02/GB/mo |
| Uptime + error monitoring | **$0–30** | Free tiers cover this scale |
| **Subtotal** | **$13–90/mo** | |

**Storage sizing.** A single instrument's L2 diff stream plus trades runs roughly
0.5–3 GB/day uncompressed, depending on venue and depth levels captured. Compressed
(zstd) that is ~10–20% of raw. Call it **5–20 GB/month compressed** per instrument. A year
of one instrument fits comfortably in 100–250 GB.

The relevant point is not the cost — it is that **this data cannot be bought retroactively at
that price.** Historical L2 from a vendor costs $99–500/month. Recording it yourself costs
...
| News: commercial aggregator | ⚠️ **$50–450/mo** | Phase 2 — wide range; entry tiers exist well under $100 |
| Historical crypto tick/L2 archive | ⚠️ **$99–500/mo** | Phase 3, avoidable if we record from Phase 1 |
| Futures MBO (Databento / Rithmic / dxFeed) | ⚠️ **$100–1,000/mo** vendor | Phase 5+ |
| **CME exchange fees on top of the vendor** | ⚠️ **$500–3,000+/mo** | The part that surprises people |
...
|---|---|---|
| Hourly bars (24 cycles/day) | ~2,160 | **$10–80** |
| 15-min bars (96/day) | ~8,640 | **$40–320** |
| 1-min bars / scalping (1,440/day) | ~130,000 | **$600–4,800** |
...
This is where hardware budgets usually break. Roughly 5–8 kW of continuous load in a
domestic or small-office space is a building services problem, not a computer problem.

| Item | Estimate ⚠️ | Note |
|---|---|---|
| High-speed switch (100GbE+) | **$8,000–25,000** | Needed only if nodes must interconnect at speed — see below |
| Cables + transceivers (33+) | **$5,000–13,000** | $150–400 each |
| Racking / shelving | **$1,000–3,000** | The stacked layout is a visual concept; operation needs airflow |
| PDUs + electrical work | **$2,500–12,000** | 5–8 kW needs dedicated circuits |
| Cooling | **$3,000–15,000** | 5–8 kW of heat needs real extraction, not a fan |
| UPS | **$2,000–8,000** | |
| **Non-compute subtotal** | **$21,500–76,000** | |
| **All-in, 33 units** | **$153,500–231,000** | |
| **Electricity, ongoing** | **$450–1,700/mo** | ~4,400–5,800 kWh/mo at $0.10–0.30/kWh, plus cooling overhead |
...
|---|---|---|
| **1–2 DGX Sparks to benchmark** | **$4,000–9,400** | The only defensible first purchase. Answers the sizing question for ~5% of the full spend. |
| Cloud GPU rental | ~$0.50–3/hr on demand | No capex, no power, no cooling; poor economics at 24/7 |
| Colocation instead of on-premises | $200–800/mo/rack + power | Someone else solves cooling, power and physical security |
...
**Recommended first live allocation: $10,000–25,000**, treated as fully at risk.

The reason for a floor rather than starting tiny: below roughly $10k, the fixed components
of trading cost swamp the signal, so a losing result tells you nothing about the strategy —
you have merely proven that fees exist. That is an expensive way to learn nothing.
...
| **Phase 1** (real data) | **$15–60** | VPS, storage, domain — the depth archive starts accruing |
| **Phase 2** (publishing) | **$30–200** | Adds news feed and modest LLM usage |
| **Phase 3** (validation) | **$50–350** | Adds historical data if not self-recorded |
| **Phase 4** (live, small) | **$50–350** + capital | Same infra; capital is separate |
| **Phase 5** (owned cluster) | **$500–1,800** | Electricity and cooling dominate |

### One-time costs

| Item | Range |
|---|---|
| Benchmark hardware (1–2 units) | $4,000–9,400 |
| Legal review — token, jurisdiction, the NVDA pair | ⚠️ $5,000–25,000+ |
| Full 33-unit build, all-in | $153,500–231,000 |
| First live trading capital | $10,000–25,000 |
