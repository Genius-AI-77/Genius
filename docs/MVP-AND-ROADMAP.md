...
5. ✅ ATLAS reads live RSS headlines (3–4 public feeds), lexicon-scored, time-gated
...
### Phase 3 — Validate the edge *(≈3–6 weeks, gated on Phase 2)*
...
**Gate:** if this fails, the honest outcome is publishing that it failed and iterating —
not proceeding to Phase 4. Phase 4 without Phase 4's prerequisite is how people lose money.
...
1. Benchmark the real workload on **1–2** DGX Sparks before buying 33
...
All eight are live on the site today, sections 01–09.
