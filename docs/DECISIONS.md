...
|---|---|---|---|
| 1-hour | 24 | $10–80 | Swing; current default |
| 15-min | 96 | $40–320 | Intraday |
| 1-min | 1,440 | $600–4,800 | Scalping — the brief mentions this |
...
when they become inconvenient. Any change lands as a one-line diff with visible git history —
that is deliberate.
...
- **The real all-in figure is $153k–231k**, not $148.5k. Power, cooling, networking, racking
  and UPS add $21k–76k, plus $450–1,700/month in electricity.

**What I need:** approval for a 1–2 unit benchmark purchase, or a decision to defer hardware
